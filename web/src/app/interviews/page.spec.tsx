    ...
    interviews: {
      list: {
        useQuery: () => ({
          ...
          error: null,
          data: [
            { id: 'i1', company: 'Acme', role: 'FE Dev', stage: 'SCREEN',  scheduledAt: new Date().toISOString() },
            { id: 'i2', company: 'Globex', role: 'BE Dev', stage: 'ONSITE', scheduledAt: new Date().toISOString() },
          ],
        }),
      },
    },
